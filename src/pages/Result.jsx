                    ...
                    <div>
                      ...
                      <ul className="ui-search-rescue__list">
                        <li className="ui-search-rescue__item">
                          <strong>Escribe tu búsqueda</strong> en el campo que
                          figura en la parte superior de la pantalla.
                        </li>
                        <li className="ui-search-rescue__item">
                          <a href="https://www.mercadolibre.cl/categories.html">
                            {" "}
                            Navega por categorías de productos
                          </a>{" "}
                          para encontrar el producto que buscas.
                        </li>
                      </ul>
                    </div>
                  </Col>
